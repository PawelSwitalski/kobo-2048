...
cd /mnt/onboard/.adds/kobo_2048 || exit 1

# Touch-panel calibration overrides, if this model needs them (see docs/settings.md):
# export KOBO_2048_TOUCH_SWAP_XY=1
# export KOBO_2048_TOUCH_MIRROR_X=1
# export KOBO_2048_TOUCH_MIRROR_Y=1
# export KOBO_2048_TOUCH_DEBUG=1
